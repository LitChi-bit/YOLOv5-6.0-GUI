...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./icon/运行.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        icon3.addPixmap(QtGui.QPixmap("./icon/运行.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("./icon/运行.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "YOLOv5s-Detection for Cervical Cancer Abnormal Cells"))
        MainWindow.setWindowOpacity(1)
        self.label_2.setText(_translate("MainWindow", "输入图像"))
        self.label.setText(_translate("MainWindow", "输出图像结果"))
        self.toolBar.setWindowTitle(_translate("MainWindow", "toolBar"))
        self.SelModel.setText(_translate("MainWindow", "选择模型"))
        self.SelModel.setToolTip(_translate("MainWindow", "选择模型"))
        self.SelFile.setText(_translate("MainWindow", "选择图像"))
        self.SelFile.setToolTip(_translate("MainWindow", "选择图像"))
        self.RunProgram.setText(_translate("MainWindow", "运行"))
        self.RunProgram.setToolTip(_translate("MainWindow", "运行"))
